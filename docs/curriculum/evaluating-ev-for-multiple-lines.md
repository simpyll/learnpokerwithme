...
## I. The Mathematical Baseline: EV of Folding 
...
$$EV_{fold} = 0$$
This valuation is absolute because all capital previously committed to the pot by the operator is classified as a sunk cost. The 
$EV_{fold}$
serves as the quantitative baseline against which the expected value of all subsequent aggressive or passive actions must be measured. Any line producing an $EV < 0$ mathematically dictates a 100% folding frequency under Game Theory Optimal (GTO) equilibrium.

## II. The Passive Line: EV of Calling 
...
## III. The Aggressive Line: EV of Raising 
